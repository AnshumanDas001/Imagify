...
const navbar = () => {
  ...
  return (<div className='flex item-center justify-between py-4'>
    <div>
    ...
    <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
            <button onClick={()=>{navigate('/buy')}} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
                ...
                <p className='text-xs sm:text-sm font-medium text-grey-600'>Credits left : {credit || 0}</p>
            </button>
        ...
        :
        <div className='flex items-center gap-2 sm:gap-5' onClick={()=>setShowLogin(true) }>
